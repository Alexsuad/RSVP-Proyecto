...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "es": {
        ...
        "request.email_or_phone_conflict": "El correo o teléfono ya está registrado por otro invitado.",
    ...
    "ro": {
        ...
        "request.email_or_phone_conflict": "Emailul sau telefonul este deja înregistrat de un alt invitat.",
    ...
    "en": {
        ...
        "request.email_or_phone_conflict": "The email or phone is already registered by another guest.",
